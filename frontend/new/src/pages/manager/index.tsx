...
export default function Page() {
  ...
  async function fetchData(params: {[key: string]: any}): Promise<{ data: RawData[]; success: boolean; }> {
    // 将查询参数转换为URL查询字符串
  ...
  useEffect(() => {
    ...
    const getPartChartColumns = (Click: (record: PartItem) => void) : ColumnsType<PartItem>[] => {return [
    {
      dataIndex: 'index',
  ...
  return (
    ...
    <MainMenuBar keyy='manage'/>
      ...
      <ProTable <TableListItem>
        ...
        expandable={{expandedRowRender: (record, index) => <ExpandableRender keyy={index}/>}}
        />
          </div>
        </Layout>
        </>
